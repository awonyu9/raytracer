# run_rt_left.py -- raytrace a scene with a simple progress indicator
#    usage: pypy run_rt_left.py scene0 320 240
...
def main():
    ...
    for i in range(90):
        ...
        t2 = time.time()
        img.save("rb-left/{}-rt-{:d}-{:d}-{}.ppm".format(scenename, w, h, i))
